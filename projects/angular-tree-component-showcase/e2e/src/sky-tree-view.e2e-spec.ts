...
describe('Tree view', () => {
  ...
  it('should match previous screenshot with node active', async (done) => {
    await SkyHostBrowser.scrollTo('#screenshot-tree-view-basic');
    await element.all(by.css('#screenshot-tree-view-basic .node-content-wrapper')).get(1).click();
    expect('#screenshot-tree-view-basic').toMatchBaselineScreenshot(done, {
  ...
  it('should match previous screenshot with context menus and checkboxes', async (done) => {
    await SkyHostBrowser.scrollTo('#screenshot-tree-view-context-menus-and-checkboxes');
  ...
  it('should match previous screenshot when collapsed', async (done) => {
    ...
    await element(by.css('#screenshot-tree-view-cascading-checkboxes .sky-angular-tree-collapse-all-btn')).click();
  ...
  it('should match previous screenshot with checkboxes', async (done) => {
    await SkyHostBrowser.scrollTo('#screenshot-tree-view-cascading-checkboxes');
    await element.all(by.css('#screenshot-tree-view-cascading-checkboxes .node-content-wrapper')).get(1).click();
    expect('#screenshot-tree-view-cascading-checkboxes').toMatchBaselineScreenshot(done, {
  ...
  it('should match previous screenshot with single select mode', async (done) => {
    ...
    await element.all(by.css('#screenshot-tree-view-single-select .node-content-wrapper')).get(1).click();
